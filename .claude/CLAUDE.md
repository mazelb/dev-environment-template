...
**Primary Purpose**: Enable teams to quickly create new projects with best-practice configurations for Python, TypeScript/JavaScript, and Kotlin development.
...
- Flyway for Kotlin projects
- Naming: `YYYYMMDD_HHmmss_description.sql` or autogenerated
- Always reversible (up/down migrations)
- Test migrations on staging before production

### Queries
- **Always use parameterized queries** (prevents SQL injection)
- Use ORMs when possible (SQLAlchemy, JPA)
...
- **11 Slash Commands**: Core (explain, refactor, test, document), Analysis (optimize, debug, security, architecture), DevOps (docker-optimize, ci-review), Data (sql-optimize)
...
- `docs/CLAUDE_CODE_MIGRATION.md` - Continue.dev → Claude Code
- `docs/CLAUDE_COMMANDS_GUIDE.md` - Slash commands reference
- `docs/CLAUDE_SKILLS_GUIDE.md` - Skills usage
- `docs/CLAUDE_WORKFLOW.md` - Daily workflow with Claude Code
