...
function Test-ProjectStructure {
    ...
    $requiredPaths = @(
        ...
        @{ Path = "src/models"; Type = "Directory"; Description = "Database models directory" },
        @{ Path = "src/schemas"; Type = "Directory"; Description = "Pydantic schemas directory" },
        @{ Path = "src/services"; Type = "Directory"; Description = "Business logic services" },
        @{ Path = "src/tasks"; Type = "Directory"; Description = "Celery tasks directory" },
        @{ Path = "tests"; Type = "Directory"; Description = "Tests directory" },
        @{ Path = "alembic"; Type = "Directory"; Description = "Database migrations directory" },
