...
function Test-ProjectStructure {
    ...
    $requiredPaths = @(
        ...
        @{ Path = "src/schemas"; Type = "Directory"; Description = "Pydantic schemas" },
        @{ Path = "src/services"; Type = "Directory"; Description = "Business logic" },
        @{ Path = "src/tasks"; Type = "Directory"; Description = "Celery tasks" },
